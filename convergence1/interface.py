...
def assemble_cominations():
    ...
    #open csv file and create iterable numpy_array out of it (4x10)
    csvfile = open(r"C:\Users\Jose Matthias\Desktop\Uni\Bachelorarbeit_Inhalt\Simulations\examplecsvpythoninput.csv")
